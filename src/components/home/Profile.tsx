    ...
    return (
        ...
        >
            ...
            {researchInterests && researchInterests.length > 0 && (
                <div className="bg-accent/[0.08] dark:bg-neutral-800 border border-accent/20 dark:border-neutral-700/50 rounded-lg p-4 mb-6 hover:shadow-lg transition-all duration-200 hover:scale-[1.02]">
