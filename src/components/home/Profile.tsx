    ...
    return (
        ...
        >
            ...
            {researchInterests && researchInterests.length > 0 && (
                <div className="bg-[#faf9f5] dark:bg-neutral-800 border border-[#e8e2d7] dark:border-[rgba(148,163,184,0.24)] rounded-lg p-4 mb-6 shadow-sm hover:shadow-lg transition-all duration-200 hover:scale-[1.02]">
